...
const previousWorkshops = [
  ...
  },
  {
    ...
    date: "May 2025",
    attendees: 24,
    description: "This linocut art workshop is beginner-friendly and deeply inspiring.Discover the joy of slow art, mindful making, and hands-on creative experiences.",
    reviews: [
      { name: "Arjun Reddy", rating: 5, date: "Nov 15, 2025 • 9:30 AM", comment: "The energy was electric, the prints were stunning, and the vibe? Pure Rabuste.", avatar: "A" },
      { name: "Priya Singh", rating: 5, date: "Nov 16, 2025 • 5:20 PM", comment: "Hands in ink, hearts full, and minds flowing with inspiration — that’s how we do Sundays!", avatar: "P" },
    ],
  },
  {
    id: "3",
    title: "Father's Day Coffee Art Workshop",
    image: "/workshops/3.jpg",
    date: "June 2025",
    attendees: 30,
    description: "This Father’s Day 2025, give your dad a memory that’s brewed with love and finished with a touch of creativity!",
    reviews: [
      { name: "Sudhir Gupta", rating: 5, date: "Oct 20, 2025 • 11:00 AM", comment: "Led by the talented Charanjeet Singh, the workshop became a memory-making canvas filled with stories, smiles, and steaming cups.", avatar: "S" },
      { name: "Karan Mehta", rating: 5, date: "Oct 21, 2025 • 3:45 PM", comment: "From extracting rich shots of blended beans and robusta beans, to creating soulful coffee art, every moment was crafted with care.", avatar: "K" },
    ],
  },
  {
    id: "4",
  ...
  },
  {
    ...
    date: "Aug 2025",
    attendees: 35,
    description: " This Ganesh Chaturthi, let’s create with love and care for the earth",
    reviews: [
      { name: "Nisha Reddy", rating: 5, date: "Jul 22, 2025 • 8:00 PM", comment: "Every corner of Rabuste was alive with conversations, creativity & coffee aroma.", avatar: "N" },
      { name: "Amit Desai", rating: 5, date: "Jul 23, 2025 • 7:30 PM", comment: "The joy of creating with hands matched perfectly with sips of specialty robusta coffee.", avatar: "A" },
    ],
  },
];
