...
export default function Footer() {
    ...
    return (
        <footer className="w-full bg-[#120d0a] text-white py-12 border-t border-neutral-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-neutral-400">
                            ...
                            <li>
                                <Link href="/menu" className="hover:text-white transition-colors duration-200">
                                    Our Menu
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href="/workshops" className="hover:text-white transition-colors duration-200">
                                    Workshops
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-neutral-400">
                            ...
                            <li>
                                <Link href="/about-us#franchise" className="hover:text-white transition-colors duration-200">
                                    Franchise
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4 mb-6">
                            <Link
                                ...
                                className="p-2 bg-neutral-900 rounded-full hover:bg-neutral-800 transition-colors duration-200"
                        ...
                        <div className="space-y-2">
                            <a
                                href="mailto:rabustecoffee@gmail.com"
                                className="block text-neutral-400 text-sm hover:text-white transition-colors"
                            >
                                rabustecoffee@gmail.com
                            </a>
                            <a
                                href="tel:+918967889090"
                                className="block text-neutral-400 text-sm hover:text-white transition-colors"
                            >
                                +91 89678-89090
                            </a>
