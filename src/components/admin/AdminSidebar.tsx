    ...
    return (
        <>
            ...
            >
                    ...
                    {navigation.map((item) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span 
                                    className={`font-serif tracking-wide text-sm transition-all duration-300 ${
                ...
                {/* Footer */}
                <div className={`absolute bottom-0 left-0 right-0 p-6 border-t border-[#4A3B28]/10 bg-[#D8CBB8] overflow-hidden whitespace-nowrap transition-all duration-300 ${
