...
const categoryFilters: { id: MenuCategory | "all"; label: string }[] = [
    { id: "all", label: "All" },
    { id: "rabuste-special", label: "Rabuste Special" },
        ...
        if (searchQuery.trim() && searchService) {
            try {
                ...
                if (selectedCategory !== "all") {
                    if (selectedCategory === "rabuste-special") {
                        // Show only items marked as rabuste special
                        results = results.filter(item => item.is_rabuste_special === true);
                    } else {
            ...
            if (selectedCategory === "all") {
                results = items;
            } else if (selectedCategory === "rabuste-special") {
                // Show only items marked as rabuste special
                results = items.filter(item => item.is_rabuste_special === true);
            } else {
                results = items.filter(item => item.category === selectedCategory);
            }
        } else {
            ...
            <div className="mx-auto w-full px-4 lg:px-6 max-w-7xl">
                  ...
                  py-2 w-full`}
                                >
                                    <div className="pl-3 lg:pl-4 text-[#262626]">
                                        <svg
                                            ...
                                            viewBox="0 0 24 24"
                                            fill="currentColor"
                                            className={`w-4 h-4 lg:w-5 lg:h-5 transition-transform duration-300 ${showSuggestions ? "scale-110 text-[#8B6F47]" : "text-[#262626]"
                                                }`}
                                        >
                                            <path
                                                fillRule="evenodd"
                            ...
                            <div className="relative dropdown-container">
                                <button
                                    ...
                                    className={`flex items-center gap-1 px-4 py-2 border-[0.5px] font-sans text-sm font-semibold transition-all whitespace-nowrap ${advancedFilters.dealsOnly || advancedFilters.temperature !== 'all' || advancedFilters.milk !== 'all' || advancedFilters.priceRange !== 'all'
                                    ...
                                    <div className="absolute top-full left-0 lg:left-auto lg:right-0 mt-1 bg-white rounded-lg shadow-lg border-[0.5px] border-[#8B6F47] overflow-hidden z-20 w-[min(240px,calc(100vw-2rem))] lg:w-auto max-h-[400px] overflow-y-auto lg:overflow-visible">
                                            ...
                                            <div className="p-3 min-w-[180px]">
                                                ...
                                                {[
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-3 py-2 font-sans text-sm transition-all rounded mb-1 ${advancedFilters.temperature === option.value
                                                            ? "bg-[#8B6F47] text-white font-semibold"
                                            ...
                                            <div className="p-3 min-w-[160px]">
                                                ...
                                                {[
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-3 py-2 font-sans text-sm transition-all rounded mb-1 ${advancedFilters.milk === option.value
                                                            ? "bg-[#8B6F47] text-white font-semibold"
                                                            : "bg-transparent text-[#262626] hover:bg-[#f5f5f0]"
                                                            }`}
                                                    >
                                            ...
                                            <div className="p-3 min-w-[160px]">
                                                ...
                                                {[
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-3 py-2 font-sans text-sm transition-all rounded mb-1 ${advancedFilters.priceRange === option.value
                                                            ? "bg-[#8B6F47] text-white font-semibold"
                                                            : "bg-transparent text-[#262626] hover:bg-[#f5f5f0]"
                                                            }`}
                                                    >
                                            ...
                                            <div className="p-3 min-w-[140px] flex flex-col">
                                                <div className="flex-1">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-3 py-2 font-sans text-sm transition-all rounded mb-1 flex items-center justify-between ${advancedFilters.dealsOnly
                                                            ? "bg-[#8B6F47] text-white font-semibold"
                                                            : "bg-transparent text-[#262626] hover:bg-[#f5f5f0]"
                                                            }`}
                                                    >
                                        ...
                                        <div className="lg:hidden grid grid-cols-2 divide-x divide-y divide-[#8B6F47]/10">
                                            ...
                                            <div className="p-2">
                                                ...
                                                {[
                                                    ...
                                                    <button
                                                        key={option.value}
                                                        onClick={() => setAdvancedFilters(prev => ({ ...prev, temperature: option.value as any }))}
                                                        className={`w-full text-left px-2 py-1 font-sans text-xs transition-all rounded mb-0.5 ${advancedFilters.temperature === option.value
                                                            ? "bg-[#8B6F47] text-white font-semibold"
                                                            : "bg-transparent text-[#262626] hover:bg-[#f5f5f0]"
                                                            }`}
                                                    >
                                            ...
                                            <div className="p-2">
                                                ...
                                                {[
                                                    ...
                                                    <button
                                                        key={option.value}
                                                        onClick={() => setAdvancedFilters(prev => ({ ...prev, milk: option.value as any }))}
                                                        className={`w-full text-left px-2 py-1 font-sans text-xs transition-all rounded mb-0.5 ${advancedFilters.milk === option.value
                                                            ? "bg-[#8B6F47] text-white font-semibold"
                                                            : "bg-transparent text-[#262626] hover:bg-[#f5f5f0]"
                                                            }`}
                                                    >
                                            ...
                                            <div className="p-2">
                                                ...
                                                {[
                                                    ...
                                                    <button
                                                        key={option.value}
                                                        onClick={() => setAdvancedFilters(prev => ({ ...prev, priceRange: option.value as any }))}
                                                        className={`w-full text-left px-2 py-1 font-sans text-xs transition-all rounded mb-0.5 ${advancedFilters.priceRange === option.value
                                                            ? "bg-[#8B6F47] text-white font-semibold"
                                                            : "bg-transparent text-[#262626] hover:bg-[#f5f5f0]"
                                                            }`}
                                                    >
                                            ...
                                            <div className="p-2 flex flex-col justify-start">
                                                ...
                                                <button
                                                    onClick={() => setAdvancedFilters(prev => ({ ...prev, dealsOnly: !prev.dealsOnly }))}
                                                    className={`w-full text-left px-2 py-1 font-sans text-xs transition-all rounded flex items-center justify-between ${advancedFilters.dealsOnly
                                                        ? "bg-[#8B6F47] text-white font-semibold"
                                                        : "bg-transparent text-[#262626] hover:bg-[#f5f5f0]"
                                                        }`}
                                                >
                ...
                {selectedCategory === "all" ? (
                    <div className="space-y-12">
                        {/* Rabuste Special Section - Show first if there are special items */}
                        {(() => {
                            const specialItems = filteredItems.filter((item) => item.is_rabuste_special === true);
                            if (specialItems.length === 0) return null;

                            return (
                                <div key="rabuste-special" data-category="rabuste-special">
                                    <motion.div
                        ...
                        {/* Regular categories - excluding rabuste-special virtual category */}
                        {categoryFilters
                            .filter((cat) => cat.id !== "all" && cat.id !== "rabuste-special")
                            .map((category) => {
