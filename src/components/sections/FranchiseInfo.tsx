        ...
        >
            <div className="relative z-10 mx-auto w-full max-w-7xl px-4 lg:px-6 flex flex-col items-center">
                ...
                <motion.h2
                    ...
                    className="font-display text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 lg:mb-12 text-center text-[#262626]"
                >
                    Own our Franchise
                </motion.h2>
                ...
                <div className="grid grid-cols-3 gap-2 lg:gap-8 w-full max-w-5xl mb-4 lg:mb-12">
                    {benefits.map((benefit, index) => (
                        ...
                        >
                            <div className="p-3 lg:p-4 rounded-full bg-[#8B6F47]/10 mb-2 lg:mb-6 group-hover:bg-[#8B6F47]/20 transition-colors duration-300">
                                <benefit.icon className="w-6 h-6 lg:w-10 lg:h-10 text-[#6F4E28]" />
                            </div>
                            <h3 className="font-serif text-sm lg:text-xl font-bold mb-1 lg:mb-3 text-[#2a2a2a]">
                                {benefit.title}
                            </h3>
                            <p className="text-[#575757] text-xs lg:text-base leading-tight lg:leading-relaxed font-serif hidden lg:block">
                                {benefit.description}
                            </p>
                        </motion.div>
                    ))}
            ...
            <span className="flex space-x-[2px]">
                {text.split("").map((char, index) => (
                    <motion.span
                        ...
                        className="inline-block font-serif text-lg lg:text-xl font-semibold text-[#262626]"
                    >
                        {char === " " ? "\u00A0" : char}
                    </motion.span>
                ))}
