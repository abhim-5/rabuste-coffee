...
import { CheckCircle, X, Calendar, Clock, Coffee } from "lucide-react";
...
export function WorkshopConfirmation({
    isOpen,
    onClose,
    bookingNumber,
    workshopTitle,
                        ...
                        <div className="bg-gradient-to-br from-[#F5EFE6] to-[#E8DBC8] rounded-2xl shadow-2xl max-w-md w-full border-2 border-[#8B6F47] overflow-hidden">
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="space-y-3">
                                    <div>
                                        <p className="font-sans text-sm text-[#8B6F47] mb-1">Workshop</p>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p className="font-sans text-sm text-[#8B6F47]">Date</p>
                                            <p className="font-serif text-base text-[#262626]">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p className="font-sans text-sm text-[#8B6F47]">Time</p>
                                            <p className="font-serif text-base text-[#262626]">{time}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                                    <p className="font-sans text-sm text-amber-900 leading-relaxed">
                                        ...
                                        <br />
                                        1. Save this booking number for your records
                                        <br />
                                        2. Arrive 10 minutes before the workshop starts
                                        <br />
                                        3. Payment can be made at the venue (cash/card)
                                    </p>
                                </div>
